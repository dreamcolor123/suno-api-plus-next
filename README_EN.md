...
Self-hosted Suno API gateway with account pools, OpenAI-compatible endpoints,
Studio workflows, and a source-only Fast Upload implementation.
...
- [Authentication and account affinity](#authentication-and-account-affinity)
- [Uploads and Fast Upload](#uploads-and-fast-upload)
- [Studio Advanced Split](#studio-advanced-split)
- [OpenAI-compatible API](#openai-compatible-api)
- [Native routes](#native-routes)
- [Security checklist](#security-checklist)
- [Migration](#migration-from-suno-api-plus)
